...
const Rating: React.FC<{ rating: number; showOnlyActive?: boolean }> = ({
  rating,
  showOnlyActive,
}) => {
  return (
    <ul className="flex justify-center">
      <li>
        <svg
          ...
          className={classNames(
            rating === 1 ? "bg-amber-300 text-gray-800" : "text-gray-500",
            showOnlyActive ? (rating === 1 ? "" : "hidden") : "",
            "w-5 mr-1 rounded-full"
          )}
          role="img"
      ...
      <li>
        <svg
          ...
          data-icon="frown"
          className={classNames(
            rating === 2 ? "bg-amber-300 text-gray-800" : " text-gray-500",
            showOnlyActive ? (rating === 2 ? "" : "hidden") : "",
            "w-5 mr-1 rounded-full"
          )}
          role="img"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        <svg
          ...
          data-icon="meh"
          className={classNames(
            rating === 3 ? "bg-amber-300 text-gray-800" : " text-gray-500",
            showOnlyActive ? (rating === 3 ? "" : "hidden") : "",
            "w-5 mr-1 rounded-full"
          )}
          role="img"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        <svg
          ...
          data-icon="smile"
          className={classNames(
            rating === 4 ? "bg-amber-300 text-gray-800" : " text-gray-500",
            showOnlyActive ? (rating === 4 ? "" : "hidden") : "",
            "w-5 mr-1 rounded-full"
          )}
          role="img"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        <svg
          ...
          className={classNames(
            rating === 5 ? "bg-amber-300 text-gray-800" : " text-gray-500",
            showOnlyActive ? (rating === 5 ? "" : "hidden") : "",
            "w-5 mr-1 rounded-full"
          )}
          role="img"
          xmlns="http://www.w3.org/2000/svg"
